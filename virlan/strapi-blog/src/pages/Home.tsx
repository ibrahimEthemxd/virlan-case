  ...
  export const getServerSideProps = async () => {
    const apiUrl = process.env.STRAPI_API_URL || "http://localhost:1337/api/blogs?populate=*";
    const blogs = await fetchBlogs(apiUrl);
  ...
  export default function Home({ blogs = [] }: { blogs: Blog[] }) {
    return (
      <div className="max-w-4xl mx-auto p-4">
        <h1 className="text-3xl font-bold mb-4 bg-blue-500">Bloglar</h1>
